...
try:   
  ...
  LampCSV_Reader = csv.reader(open(Point_CSV_File, 'rU'), delimiter=',', quotechar='|')
  ...
  csvReader = csv.reader(open(WorkPacket_CSV_File, 'rU'), delimiter=',', quotechar='|')
